...
export default function PrivacyClient() {
  useEffect(() => {
    ...
    script.src = "https://g.ezoic.net/privacy/embed.js";
    script.async = true;
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 mt-16">
        <Card className="shadow-xl border border-[#0F766E] rounded-2xl">
          ...
          <CardContent className="space-y-6 text-black text-sm md:text-base leading-relaxed">
            ...
            {/* Ezoic Embed Injects Automatically Here */}
            ...
            <p>
              Like many websites, Guess My College uses log files. The information includes IP address, browser type, ISP, date/time, and referring/exit pages. This is not linked to personally identifiable data and is used to optimize site performance.
            </p>
            ...
            <p>
              We may use tools like Google Analytics or AdSense, which may collect non-personal information via cookies.
            </p>
            ...
            <p>
              Our platform is for students aged 13 and older. We do not knowingly collect information from children under 13.
            </p>
