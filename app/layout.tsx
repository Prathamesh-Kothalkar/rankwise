      ...
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "applicationCategory": "College Predictor",
            "operatingSystem": "All",
            "creator": {
              "@type": "Person",
              "name": "Prathamesh Kothalkar",
